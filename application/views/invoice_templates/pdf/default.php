                ...
                <tr>
                    <td id="company-name">
                        ...
                        <p>
                            ...
                            <?php if ($invoice->user_phone) { ?><abbr>Sími:</abbr><?php echo $invoice->user_phone; ?><br><?php } ?>
			    <?php if ($invoice->notandi_custom_kennitala) { ?><abbr>Kennitala:</abbr><?php echo $invoice->notandi_custom_kennitala; ?><br><?php } ?>
                            <?php if ($invoice->notandi_custom_reikningsnr) { ?><abbr>Reikningsnúmer:</abbr><?php echo $invoice->notandi_custom_reikningsnr; ?><br><?php } ?>
			    <?php if ($invoice->notandi_custom_vsk) { ?><abbr>VSK-númer:</abbr><?php echo $invoice->notandi_custom_vsk; ?><?php } ?>
                        </p>
                    </td>
                ...
                <tr>
                    <td style="padding-left: 5px;">
                        ...
                        <p><?php echo $invoice->client_name; ?><br>
                            ...
                            <?php if ($invoice->client_phone) { ?><abbr>Sími:</abbr><?php echo $invoice->client_phone; ?><br><?php } ?>
 			    <?php if ($invoice->client_custom_kennitala) { ?><abbr>Kennitala:</abbr><?php echo $invoice->client_custom_kennitala; ?><br><?php } ?>
